...
export class SignInPageComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.queryParams.subscribe(params => {
      ...
      this.auth$ = this.http.get<any>(this.profileAPIURL + "/auth/signin?login_challenge=" + this.login_challenge).pipe(
        map((data: any) => {
          console.log(data)
  ...
  postSignIn(): void {
    const url = this.profileAPIURL + "/auth/signin?login_challenge=" + this.login_challenge + "&_csrf=" + this.csrf
